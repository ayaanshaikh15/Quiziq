   ...
   <>
    <div className="pt-18 sm:pl-56 md:pl-64 m-8">
       ...
       <div className="flex gap-2 justify-center items-center shadow-[0_0_20px_rgba(168,85,247,0.2)] rounded-2xl my-8 p-4 bg-navbar ">
         ...
         <input value={search} onChange={(e) => setsearch(e.target.value)} type="text" placeholder="Search quizzes..."  className={
    theme === "dark"
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="flex flex-col gap-1">
          ...
          <p className="text-gray-400 text-[9px] md:text-[13px]">{value.date} . {value.questions} questions</p>
